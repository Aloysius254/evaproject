...
function openLightbox(img){
  ...
  imagesList = Array.from(document.querySelectorAll(".gallery img"));
  ...
  image.src = imagesList[currentIndex].src;
}
...
function nextImage(){
  ...
  document.getElementById("lightbox-img").src = imagesList[currentIndex].src;
}
